          ...
          <div className="relative pt-24 pb-10 px-6 sm:px-12 sm:pb-14 grid gap-6 lg:grid-cols-[1.5fr_1fr] items-center">
            ...
            <div className="flex flex-col gap-3">
              ...
              <Link
                ...
                className="inline-flex items-center justify-center h-12 px-5 rounded-[var(--radius)] bg-transparent border-2 border-white/30 text-white font-semibold hover:bg-white/10 transition-colors"
              >
