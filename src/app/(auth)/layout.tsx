...
export default function AuthLayout({
  ...
  return (
    <main className="relative min-h-[calc(100vh-4rem)] flex items-center justify-center px-5 py-10 sm:py-16 fx-grid-paper">
      {/* Decorative blobs */}
      <div
        aria-hidden
      ...
      <div className="relative w-full max-w-md space-y-5 animate-[var(--animate-fade-up)]">
        <Link
          href="/"
          className="inline-flex items-center gap-2 font-display font-extrabold text-2xl text-ink-700 hover:text-brand-600 transition-colors"
        >
